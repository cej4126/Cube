...
#include "optional.h"  // for opt::optional
...
namespace sig
{
   ...
   namespace detail
   {
      namespace traits
      {
         ...
         template<typename T>
         struct is_weak_ptr<T, void_t<decltype(std::declval<T>().expired()), decltype(std::declval<T>().lock()),
         ...
         struct result_of_func_impl
         {
            ...
            static result_of_success<decltype(std::declval<Func>()(std::declval<Args>()...)), invoke_func> test(int);
         ...
         struct result_of_memfun_ref_impl
         {
            ...
            static result_of_success<decltype((std::declval<T>().*std::declval<Func>())(std::declval<Args>()...)),
               invoke_memfun_ref>
               test(int);
         ...
         struct result_of_memobj_ref_impl
         {
            ...
            static result_of_success<decltype(std::declval<T>().*std::declval<F>()), invoke_memobj_ref> test(int);
         ...
         {
            template<typename F, typename T>
            static result_of_success<decltype((*std::declval<T>()).*std::declval<F>()), invoke_memobj_deref> test(int);
         ...
         struct result_of_memobj<Type Class::*, Arg>
         {
            ...
            using type = conditional_t<std::is_same<ArgVal, Class>::value || std::is_base_of<Class, ArgVal>::value,
               result_of_memobj_ref_t<MemPtr, Arg>, result_of_memobj_deref_t<MemPtr, Arg>>;
         };
         ...
         struct result_of_memfun<Func Class::*, Arg, Args...>
         {
            ...
            using type = conditional_t<std::is_base_of<Class, ArgVal>::value, result_of_memfun_ref_t<MemPtr, Arg, Args...>,
         ...
         template<bool IsMemberObjectPointer, bool IsMemberFunctionPointer, typename Func, typename... Args>
         ...
         struct invoke_result
            : public result_of_impl<std::is_member_object_pointer<remove_reference_t<Func>>::value,
            std::is_member_function_pointer<remove_reference_t<Func>>::value, Func, Args...>::type
         {
         };
      ...
      struct invoke_helper<Type Base::*>
      {
         ...
         template<typename T>
         static auto call(Type Base::* pmd, T&& t) -> decltype(get(std::forward<T>(t)).*pmd)
         {
   ...
   public:
      ...
      slot(Func&& func, Ptr&& ptr, detail::signal_base* signal = nullptr,
         detail::traits::enable_if_t<detail::traits::is_weak_ptr_convertable<Ptr>::value, void*> = nullptr)
         : m_pImpl{ new detail::slot_pmf_tracked<R, Func, decltype(to_weak(std::forward<Ptr>(ptr))), Args...>(
               std::forward<Func>(func), to_weak(std::forward<Ptr>(ptr))) }
         , m_pSignal{ signal }
      {}
   ...
   template<typename Func,
      typename Combiner = optional_last_value<typename detail::traits::function_traits<Func>::result_type>>
      class signal;
   ...
   public:
      ...
      template<typename Func,
         typename = detail::traits::enable_if_t<
         detail::traits::is_invocable_r<R, detail::traits::remove_cvref_t<Func>, Args...>::value>,
         typename = detail::traits::enable_if_t<
         !std::is_base_of<detail::slot_base, detail::traits::remove_cvref_t<Func>>::value>>
      ...
      template<typename Func, typename Ptr,
         typename = detail::traits::enable_if_t<
         detail::traits::is_invocable_r<R, detail::traits::remove_cvref_t<Func>, Ptr, Args...>::value>,
         typename = detail::traits::enable_if_t<
         !std::is_base_of<detail::slot_base, detail::traits::remove_cvref_t<Func>>::value>>
         connection connect(Func&& f, Ptr&& p)
      {
         auto       s = slot_ptr_type(new slot_type(std::forward<Func>(f), std::forward<Ptr>(p),
            static_cast<detail::signal_base*>(this)));
         connection c(s);
         add_slot(std::move(s));
         return c;
      }
